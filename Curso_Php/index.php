        ...
        <div class="conteudo">
            ...
            <nav class="modulos">
                ...
                <div class=" modulo vermelho">
                    ...
                    <ul>
                        <li>
                         <a href="exercicio.php?dir=sess&file=u">       
                         <h3> sessçao</h3>
                         </a>
                        </li>  
                ...
                <div class=" modulo vermelho">
                    <h3>13. Banco de dados </h3>
                    <ul>
                        <li>
                         <a href="exercicio.php?dir=bd&file=cone">       
                         <h3> Banco de dasos</h3>
                         </a>
                        </li>

                        <li>
                         <a href="exercicio.php?dir=bd&file=cria">       
                         <h3> Banco de dasos</h3>
                         </a>
                        </li>

                        <li>
                         <a href="exercicio.php?dir=bd&file=inserir">       
                         <h3> Inserir</h3>
                         </a>
                        </li>
                        ...
                        <li>
                         <a href="exercicio.php?dir=bd&file=excluir">       
                         <h3>Excluir</h3>
                         </a>
                        </li>
                        ...
                        <li>
                         <a href="exercicio.php?dir=bd&file=crud">       
                         <h3>Crude</h3>
                         </a>
                        </li>
